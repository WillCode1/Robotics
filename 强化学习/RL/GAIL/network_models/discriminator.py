...
class Discriminator:
    def __init__(self, env):
        ...
        with tf.variable_scope('discriminator'):
            ...
            expert_a_one_hot += tf.random_normal(tf.shape(expert_a_one_hot), mean=0.2, stddev=0.1,
    ...
    def create_model(self, state_dim, action_dim):
        ...
        action = keras.layers.Input(shape=action_dim)
        expert_a_one_hot = tf.one_hot(depth=action_dim)(action)
