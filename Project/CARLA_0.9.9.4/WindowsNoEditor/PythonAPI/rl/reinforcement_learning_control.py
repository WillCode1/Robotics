...
if __name__ == "__main__":
    ...
    env = CarEnv(IM_HEIGHT, IM_WIDTH, show_sem_camera=False, run_seconds_per_episode=20,
    ...
    stats = algo.imitation_learning(env, batch_size=batch_size, n_episode=EPISODES, load_model=load_model)
